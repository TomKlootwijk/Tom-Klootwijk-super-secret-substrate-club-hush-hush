...
1. Install, launch, hash-match and profile the locally built/inspected six-graph opcode-24 APK; ADB
...
8. Extend the data-backed editor with animation/timeline authoring, reusable scene/prefab workflows,
   ...
   their multi-graph chooser, Find Nearby Object, Find Object Ahead, When Timer Rings, the X/Y/Z translation gizmo and
