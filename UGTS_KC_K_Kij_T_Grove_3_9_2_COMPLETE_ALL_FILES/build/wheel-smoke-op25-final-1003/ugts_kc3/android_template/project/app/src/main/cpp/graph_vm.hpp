...
private:
    ...
    bool dispatchRoot(const Node& node,Dispatch dispatch) const;
    bool hasDispatchRoot(const Binding& binding,Dispatch dispatch) const;
    ...
    bool triggerLimitReported_=false,messageBatchAborted_=false;
