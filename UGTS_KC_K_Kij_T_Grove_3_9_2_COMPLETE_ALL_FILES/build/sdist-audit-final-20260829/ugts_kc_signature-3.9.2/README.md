...
- All 390 Python regression tests, the native pointer-ID/Trigger Area harnesses and the editor 2D/3D
  authoring smoke pass.
- The actual child-friendly first-steps project compiles from this repository's long Windows path
  to a 1,381,492-byte ARM64 Poco debug APK. Its two native learner graphs and packed log-polar assets are 496 and
...
`DA0564ACE5BAB8326894DFCA92AB4ECE9632A853AD62CBDE0E635CF152F8EB1D`. An authorized physical
...
capture, and the exact final hash above has not yet been confirmed on-device. Vulkan remains a future
