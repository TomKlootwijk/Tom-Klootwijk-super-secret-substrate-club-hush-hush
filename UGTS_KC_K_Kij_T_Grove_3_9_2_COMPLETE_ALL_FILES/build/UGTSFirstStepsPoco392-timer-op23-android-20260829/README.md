...
asset. The C++20 VM's append-only vocabulary currently contains 22 block types: Ready, Tick, Input
Pressed, Trigger Enter/Exit, Branch, constants/state/NodeData component reads, Repeatable Random
Number, Find Nearby Object, scalar math/comparisons, Set State, Set Component, Emit Event, Apply
Force, Set Active and Despawn.
