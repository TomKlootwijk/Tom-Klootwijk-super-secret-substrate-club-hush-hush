...
- Added an independent full-replay verifier and strict retained-head schema for the complete 524,288-cell KQK and KRK ranked partitions. It explicitly binds the white-strong canonical no-castling/no-EP/no-counters/no-history subdomain and reconstructs all successor equations without tablebase probe/generation helpers; retained heads do not promote WDL facts, and cyclic-lemma integration remains a declared v3 boundary.
