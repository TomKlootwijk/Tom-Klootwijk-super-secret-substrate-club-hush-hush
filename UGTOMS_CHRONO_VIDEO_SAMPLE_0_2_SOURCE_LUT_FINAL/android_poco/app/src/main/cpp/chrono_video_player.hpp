...
private:
    ...
    void stageExternalFrame(const std::array<float,16>& transform);
    void feedDecoder();
    void dequeueDecoder(std::size_t targetOrdinal);
    void releaseHeldOutput(std::size_t targetOrdinal);
    ...
    GLuint stagingTexture_=0;
    GLuint stagingFramebuffer_=0;
    ...
    std::size_t previousTargetOrdinal_=0;
